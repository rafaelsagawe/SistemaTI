...
namespace SistemaTI.Data.Migrations
{
    ...
    [Migration("20220310221549_Especificações com a FK")]
    partial class EspecificaçõescomaFK
    {
            ...
            modelBuilder.Entity("SistemaTI.Models.Especificacao", b =>
                {
                    ...
                    b.Property<int?>("EspecificacaoEquipamentoEspecificacaoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EspecificacaoEquipamentoEspecificacaoId");
            ...
            modelBuilder.Entity("SistemaTI.Models.Especificacao", b =>
                {
                    b.HasOne("SistemaTI.Models.Equipamento", null)
                        .WithMany("EspecificacaoEquipamento")
                        .HasForeignKey("EquipamentoIdEquipamento");

                    b.HasOne("SistemaTI.Models.Especificacao", "EspecificacaoEquipamento")
                        .WithMany()
                        .HasForeignKey("EspecificacaoEquipamentoEspecificacaoId");
                });
