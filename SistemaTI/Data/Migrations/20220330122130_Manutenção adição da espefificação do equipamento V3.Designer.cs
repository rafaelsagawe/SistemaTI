...
namespace SistemaTI.Data.Migrations
{
    ...
    [Migration("20220330122130_Manutenção adição da espefificação do equipamento V3")]
    partial class ManutençãoadiçãodaespefificaçãodoequipamentoV3
    {
            ...
            modelBuilder.Entity("SistemaTI.Models.Manutencao", b =>
                {
                    ...
                    b.HasOne("SistemaTI.Models.Especificacao", "Especificacao")
                        .WithMany("ManutencaosEspeficacao")
                        .HasForeignKey("EspecificacaoId");
